    ...
    <footer className="bg-green-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Lawn Care Pro</h3>
            <p className="mb-2">Professional lawn care and landscaping services.</p>
            <p className="mb-2">123 Green Street</p>
            <p className="mb-2">Anytown, USA 12345</p>
            <p className="mb-2">Phone: (555) 123-4567</p>
            <p>Email: info@lawncareproexample.com</p>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-green-700 text-center">
          <p>&copy; {currentYear} Lawn Care Pro. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
